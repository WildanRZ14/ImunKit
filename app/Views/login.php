...
<head>
    <meta name="dicoding:email" content="razzaqpratama76@gmail.com">  
    <meta charset="UTF-8">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <div>
                                    <label class="inforeg">Belum punya akun? <a href="<?= base_url(); ?>/register">Registrasi Sekarang</a></label>
                                </div>
                                ...
                                <?php if (session()->get('pesanGagal')) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert" style="font-size: 13px;">
                                        <strong>Login Gagal!</strong> Periksa kembali username/password Anda.
                                        <button type="button" class="btn-close btn-sm" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                            </div>
