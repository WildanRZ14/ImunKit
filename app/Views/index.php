...
<body>
  ...
  <div class="container pt-3">
            ...
            <div class="row">
                ...
                <div class="text-center">
                    <img src="<?= base_url('assets/images/website.png'); ?>" class="w-50" alt="">
                  </div>
                    <h5 class="services-title text-dark mt-4">Pendaftaran Imunisasi</h5>
                    <p class="text-secondary mt-3">Orang tua melakukan pendaftaran untuk mendapatkan informasi seputar imunisasi</p>
                </div>
            </div>
        </div>
  </section>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content" data-aos="fade-up" data-aos-duration="2000">
                        ...
                        <p class="text-secondary mt-3 text-justify">
                            ...
                            saepe quod molestiae minima eaque modi atque culpa sit libero ducimus
                             magnam nobis numquam id alias eveniet vel, animi esse ut perspiciatis
                            laborum! Doloremque inventore beatae unde officia quos culpa quis?
                        </p>
                    </div>
                </div>
            </div>
